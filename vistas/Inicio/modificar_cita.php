            ...
            <main>
                <div class="container-fluid">
                    ...
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Modificar Citas</li>
                    </ol>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <select id="txt_servicio" class="form-select mb-3" required disabled> 
                                            <option selected id="selectServicio">Selecciona una opción</option>
                                            <?php
                                                session_start();
                                                ...
                                                foreach ($datos as $key) {
                                                    echo '<option value="'.$key['Id_Servicio']. '">' . $key['Id_Servicio'] . '</option>';
                                                    $i = $i + 1;
                                                }
                                            ?>
                                        </select>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <select id="txt_barber" class="form-select mb-3" required disabled>
                                            ...
                                            <?php
                                                ...
                                                $i = 1;
                                                foreach ($datos as $key) {
                                                    echo '<option value="'.$key['Id_Barber'].'">' . $key['Id_Barber'] . '</option>';
                                                    $i = $i + 1;
                                                }
                                            ?>
                                        </select>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <!--<button id="btn_modificar" type="button" class="btn btn-success">Modificar</button>-->
                                </div>
                            </div>
                        </div>
                    </div>
